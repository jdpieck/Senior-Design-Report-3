...
The current design was able to successfully adhere an MPHX plate to a lamina in testing. This means in particular that it was able to have sufficiently precise lamina alignment (requirement 5), and a form factor which fits within a fume hood. This means that overall the design was successful in its core goal of adhering MPHX plates to lamina. The calculations done in Appendix III also indicate that the design is mechanically sound and can withstand well beyond the required 1000 MPHX plates.

== Weaknesses

A major issue with the design currently is chemical adhesive compatibility. Currently, using PC MPHX plates and PC film, the adhesion between the plate and film is not especially high. This is because we had originally designed the system for use with ABS plates and PC film, but the injection molding company had to switch to PC film in the middle of the quarter due to manufacturing quality issues. We did not perform the formal adhesive strength test (Requirement 1) due to this issue. In addition, glue application during testing was inconsistent across the plates due to warping caused by the manufacturing process (injection molding). This caused the plates to bow away from the adhesive rollers under applied pressure, leading to uneven bonding. Due to limited testing time and space, our team was unable to fully adjust the setup to account for this inherent issue with the plates.

Another major issue identified was the consistency of adhesive application. As we did not have access to the final manufactured MPHX plates until after most assembly, we did not sufficiently account for the possibility of MPHX plate bowing causing glue placement issues. 
