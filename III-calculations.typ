...
// === Plate Travel per Roller Revolution:]
=== Plate Travel per Roller Revolution
...
=== Adhesive Pot Life Constraint <glue-constraint>
// === Adhesive Pot Life Constraint:] <glue-constraint>
...
=== Worst-Case Motor Speed Requirement 
...
=== Adhesive Thinning Investigation
...
=== Additional Pot Life Mitigation
...
=== Determining Spring Compression
...
$
=== Supporting Equations @ShigleysMechanicalEngineering
...
=== Spring Geometry @ShigleysMechanicalEngineering
...
=== Material Properties Of Unpeened Springs @ShigleysMechanicalEngineering
