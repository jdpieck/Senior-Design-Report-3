...
The following is a comprehensive guide on how to properly set up, use, and clean Glue Dispensing Jig for Novel Polymer Heat Exchanger. A video demonstration can be found here:

- #link("https://youtu.be/qtS3pW5BFDw")[https://youtu.be/qtS3pW5BFDw]
...
#oasis-align[
  #figure(
  caption: [Pouring Glue in Adhesive Vat],
  image("images/Pour Glue in Vat.jpg")
)
][
#figure(
  caption: [Adhesive in Vat],
  image("images/Glue in Vat.jpg")
)
]
...
#oasis-align[
#figure(
  caption: [Plate Jig Above Lamina Jig],
  image("images/Plates Above Lamina.jpg")
)
][
#figure(
  caption: [Polymer Plates in Jig],
