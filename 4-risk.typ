...
To reduce the risk within our glue dispensing system, we tested our top 3 critical components from the DFMEA. These tests can be seen in the prototype testing plan. By testing each component and seeing that  The 4th critical component was the jig alignment which was not directly tested, but rather redesigned to remove the risk. 